...
enum GUINames {mainmenu, loadprogress, loadoutmenu, settings, hud, serverbrowser, credits, statsdisp, consolegui, 
...
bool ValidateMove(PlayerData&, const Vector3&, Meshlist&, ObjectKDTree&);
